...
checkresultpos   sub r8, r7
				 cmp r7, #0
				 ble back4
				 mov r8, #0X7FFFFFFF
				 b   back4
                 
checkresultnat   sub r8, r7
                 cmp r8, #0
				 bge back4
				 mov r8, #0X80000000
				 b   back4
...
checkresult31na add r8, r7
                cmp r8, #0
				blt back33
				ldr r8, =0X80000000
				b   back33
				
checkresult31po	add r8, r7
				cmp r8, #0
				bgt back33
				ldr r8, =0x7FFFFFFF
				b   back33
